...
public class LeadServiceTests
{
    ...
    public async Task CriarAsync_DeveCadastrarLead_QuandoDadosValidos()
    {
        ...
        var service = new LeadService(db, currentUser.Object, equipe, new NoOpLeadAssignmentService(), new NoOpAuditSink());
    ...
    public async Task CriarAsync_DeveRejeitar_QuandoCpfInvalido()
    {
        ...
        var vendedor = await factory.CriarUsuarioAsync(db, "Vendedor1");
        var currentUser = TestDbContextFactory.MockCurrentUser(vendedor.Id);
        var service = new LeadService(db, currentUser.Object, new EquipeComercialService(db, currentUser.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
    ...
    public async Task ObterPorIdAsync_DeveNegarAcesso_QuandoLeadNaoPertenceAoVendedor()
    {
        ...
        var service1 = new LeadService(db, currentUser1.Object, new EquipeComercialService(db, currentUser1.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
        ...
        var service2 = new LeadService(db, currentUser2.Object, new EquipeComercialService(db, currentUser2.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
    ...
    public async Task ListarAsync_GestorComercial_DeveVerCarteiraDaEquipe()
    {
        ...
        var serviceVendedor = new LeadService(db, currentUserVendedor.Object, new EquipeComercialService(db, currentUserVendedor.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
        ...
        var serviceGestor = new LeadService(db, currentUserGestor.Object, new EquipeComercialService(db, currentUserGestor.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
    ...
    public async Task ListarAsync_Admin_DeveVerVisaoConsolidada()
    {
        ...
        var currentUser1 = TestDbContextFactory.MockCurrentUser(vendedor1.Id);
        await new LeadService(db, currentUser1.Object, new EquipeComercialService(db, currentUser1.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink())
            .CriarAsync(NovoLeadRequest("Cliente A", documento: "52998224725", email: "a@teste.com", telefone: "11988880001"), CancellationToken.None);

        var currentUser2 = TestDbContextFactory.MockCurrentUser(vendedor2.Id);
        await new LeadService(db, currentUser2.Object, new EquipeComercialService(db, currentUser2.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink())
        ...
        var serviceAdmin = new LeadService(db, currentUserAdmin.Object, new EquipeComercialService(db, currentUserAdmin.Object), new NoOpLeadAssignmentService(), new NoOpAuditSink());
